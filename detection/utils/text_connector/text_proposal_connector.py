...
from detection.utils.text_connector.other import clip_boxes
from detection.utils.text_connector.text_proposal_graph_builder import TextProposalGraphBuilder
