# -*- coding:utf-8 -*-
import numpy as np
from detection.utils.bbox.nms import nms

from detection.utils.bbox.bbox_transform import bbox_transform_inv, clip_boxes
from detection.utils.rpn_msr.config import Config as cfg
from detection.utils.rpn_msr.generate_anchors import generate_anchors
...
def proposal_layer(rpn_cls_prob_reshape, rpn_bbox_pred, im_info, _feat_stride=[16, ], anchor_scales=[16, ]):
    ...
    im_info: a list of [image_height, image_width, channels]
