...
from detection.model_nets import vgg
from detection.utils.rpn_msr.anchor_target_layer import anchor_target_layer as anchor_target_layer_py
import numpy as np


def mean_image_subtraction(images, means=[123.68, 116.78, 103.94], num_channels=3):
